...
class BasePredictor(object):
    ...
    def get_prediction(self, clicker):
        ...
        pred_logits, pos_mask, neg_mask, att_mask, newest_click, is_positive = self._get_prediction_with_result(image_nd, clicks_lists, is_image_changed)
        ...
        return prediction.cpu().numpy()[0, 0], pos_mask, neg_mask, att_mask, newest_click, is_positive
